...
/**
 * Admin home / report queue — newest first, everything the checkpoint's
 * own "Minimum admin-side build" asks for and nothing else: no
 * analytics, no assignment, no case-management workflow. Clicking a row
 * opens its detail (app/admin/reports/[id]/page.tsx).
 */
