 ...
 * detail (app/admin/reports/[id]/page.tsx).
 *
 * Admin Command Center Phase 1 — moved here from app/admin/page.tsx
 * verbatim (no logic change) so /admin itself could become the new
 * Overview / Command Center landing page.
 */
